	...
	public static void main(String[] args) {
		...
		do {
			...
			entrada = JOptionPane.showInputDialog(null,
						"Menu principal:\n\n"
						+ "1. Criar uma lista\n"
						+ "2. Inserir um elemento E na n-ésima posição\n"
						+ "3. Remover o elemento da n-ésima posição\n"
						+ "4. Remover o elemento E da lista\n"
						+ "5. Retornar o elemento da n-ésima posição\n"
			...
			case 2: //2. Inserir um elemento E na n-ésima posição
				if ( lst == null) {
					JOptionPane.showMessageDialog(null,
			...
			case 3: // 3. Remover o elemento da n-ésima posição
				if ( lst == null) {
					JOptionPane.showMessageDialog(null,
							"Nenhuma lista foi criada ainda, você terá que fazer isso antes de poder usá-la.",
							"Ops ...", JOptionPane.WARNING_MESSAGE);
			...
			case 5: // 5. Retornar o elemento da n-ésima posição
				if ( lst == null) {
					JOptionPane.showMessageDialog(null,
			...
			case 6: // 6. Retornar todos os elementos da lista
				if ( lst == null) {
					...
					for (TDado elemento : lst.listaTodos())
						msg += elemento.getValor() + " ";
